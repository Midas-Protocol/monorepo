...
const liquidationDefaults: LiquidationDefaults = {
  ...
  SUPPORTED_OUTPUT_CURRENCIES: [AddressZero, underlying(assets, assetSymbols.WNEON)],
  SUPPORTED_INPUT_CURRENCIES: [AddressZero, underlying(assets, assetSymbols.WNEON)],
